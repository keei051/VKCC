...
from session import session  # 🟢 глобальная сессия
from config import VK_TOKEN  # если нужно, можно импортировать токен напрямую
...
async def get_link_stats(session: aiohttp.ClientSession, vk_key: str, vk_token: str) -> FullLinkStats:
    params = {
        "key": vk_key,
        "access_token": vk_token,
        "v": VK_API_VERSION,
